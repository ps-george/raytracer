...
QT_MOC_LITERAL(3, 27, 15), // "sendTextureName"
QT_MOC_LITERAL(4, 43, 10), // "updatePath"
QT_MOC_LITERAL(5, 54, 4), // "path"
QT_MOC_LITERAL(6, 59, 13) // "buttonClicked"

    },
    "TextureWidget\0textUpdated\0\0sendTextureName\0"
    "updatePath\0path\0buttonClicked"
};
...
void TextureWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->textUpdated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendTextureName((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 2: _t->updatePath((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (TextureWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextureWidget::textUpdated)) {
                *result = 0;
            }
        }
        {
            typedef void (TextureWidget::*_t)(QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextureWidget::sendTextureName)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject TextureWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TextureWidget.data,
      qt_meta_data_TextureWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void TextureWidget::textUpdated(QString _t1)
{
...
// SIGNAL 1
void TextureWidget::sendTextureName(QString _t1, bool _t2)
{
